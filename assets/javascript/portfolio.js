...
const ipgeolocation = 'https://api.ipgeolocation.io/ipgeo?apiKey=108a77b3aed2420c94c1b997dae7ba2a';
...
$(document).ready(() => {
  ...
  app.titleChanger(['prohvh', 'omegatm owns you', 'ran by klar.gg', 'uid issue', 'config issue', '=', 'omegatm.wtf', 'Song name: Day By Night']);
